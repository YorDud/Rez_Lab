...
{
	public partial class Himich_Photorez_Microtrav_Laborant : Form
	{
		public Himich_Photorez_Microtrav_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Him_Podg_2_H2SO4"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Him_Podg_2_H2O2"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Him_Podg_2_Cu2"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Himich_Photorez_Microtrav_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
...
[Him_Podg_2_pH] = @Him_Podg_2_pH
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Him_Podg_2_H2SO4" && column.Name != "Him_Podg_2_H2O2" && column.Name != "Him_Podg_2_Cu2" && column.Name != "Him_Podg_2_podtrav" && column.Name != "Him_Podg_2_pH")
				{
