...
{
	public partial class Himich_Photorez_Microtrav_Admin : Form
	{
		public Himich_Photorez_Microtrav_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Himich_Photorez_Microtrav_Admin_Load(object sender, EventArgs e)
		{
