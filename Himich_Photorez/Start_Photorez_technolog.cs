...
namespace Rez_Lab
{
    public partial class Start_Photorez_technolog : Form
    {
		private Timer timer;
		...
		public Start_Photorez_technolog()
        {
            InitializeComponent();
        ...
        private void Start_Photorez_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
...
//		}
		...
		{
			this.Hide();
			Himich_Photorez_KisOch_Technolog tmd = new Himich_Photorez_KisOch_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Himich_Photorez_Microtrav_Technolog tmd = new Himich_Photorez_Microtrav_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Himich_Photorez_Dek_Technolog tmd = new Himich_Photorez_Dek_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
