...
namespace Rez_Lab
{
    public partial class Start_Photorez_laborant : Form
    {
        public Start_Photorez_laborant()
        {
            InitializeComponent();
		...
		{
			this.Hide();
			Himich_Photorez_KisOch_Laborant tmc = new Himich_Photorez_KisOch_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Himich_Photorez_Microtrav_Laborant tmc = new Himich_Photorez_Microtrav_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Himich_Photorez_Dek_Laborant tmc = new Himich_Photorez_Dek_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
