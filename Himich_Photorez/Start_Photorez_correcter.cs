...
namespace Rez_Lab
{
	public partial class Start_Photorez_correcter : Form
	{
		...
		public Start_Photorez_correcter()
		{
			InitializeComponent();
			//TimerForButton();
			timer = new Timer();
		...
		private void Start_Photorez_correcter_Load(object sender, EventArgs e)
		{
...
//		}
		...
		{
			this.Hide();
			Himich_Photorez_KisOch_Corrector tmc = new Himich_Photorez_KisOch_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Himich_Photorez_Microtrav_Corrector tmc = new Himich_Photorez_Microtrav_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Himich_Photorez_Dek_Corrector tmc = new Himich_Photorez_Dek_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		private void Load_Processes()
		{
			//Load_Process1();
			//Cleaner();
			Load_Himich_Photorez_KisOch();
			Load_Himich_Photorez_Microtrav();
			Load_Himich_Photorez_Dek();
		...
		private void Load_Himich_Photorez_KisOch()
		{
			string query = @"
         SELECT COUNT(*) 
FROM Himich_Photorez_KisOch
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Him_Podg_1_Correction_Mat] IS NOT NULL AND [Him_Podg_1_Correction_Mat] <> '') OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Him_Podg_1_Correction_Score] IS NOT NULL AND [Him_Podg_1_Correction_Score] <> ''));";
		...
		private void Load_Himich_Photorez_Microtrav()
		{
			string query = @"
         SELECT COUNT(*) 
FROM Himich_Photorez_Microtrav
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Him_Podg_2_Correction_Mat] IS NOT NULL AND [Him_Podg_2_Correction_Mat] <> '') OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Him_Podg_2_Correction_Score] IS NOT NULL AND [Him_Podg_2_Correction_Score] <> ''));";
		...
		private void Load_Himich_Photorez_Dek()
		{
			string query = @"
         SELECT COUNT(*) 
FROM Himich_Photorez_Dek
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Him_Podg_3_Correction_Mat] IS NOT NULL AND [Him_Podg_3_Correction_Mat] <> '') OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Him_Podg_3_Correction_Score] IS NOT NULL AND [Him_Podg_3_Correction_Score] <> ''));";
		...
		private DataSet GetAllDataFromDatabase()
		{
			...
			string query = @"
            SELECT 
                [Him_Podg_1_Correction_Mat],
                [Him_Podg_1_Correction_Score],
                [Сomment]
            FROM 
            ...
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Him_Podg_1_Correction_Score] IS NOT NULL AND [Him_Podg_1_Correction_Score] <> '')
                );

            SELECT 
                [Him_Podg_2_Correction_Mat],
                [Him_Podg_2_Correction_Score],
                [Сomment]
            FROM 
            ...
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Him_Podg_2_Correction_Score] IS NOT NULL AND [Him_Podg_2_Correction_Score] <> '')
                );

            SELECT 
                [Him_Podg_3_Correction_Mat],
                [Him_Podg_3_Correction_Score],
                [Сomment]
            FROM 
                Himich_Photorez_Dek
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Him_Podg_3_Correction_Score] IS NOT NULL AND [Him_Podg_3_Correction_Score] <> '')
                );
        ";
		...
		private void PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
		{
			...
			string title = "Химическая подготовка перед нанесением фоторезиста";
