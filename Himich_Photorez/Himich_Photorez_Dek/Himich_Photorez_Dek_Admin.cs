...
namespace Rez_Lab.Himich_Photorez_Dek
{
	public partial class Himich_Photorez_Dek_Admin : Form
	{
		public Himich_Photorez_Dek_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Himich_Photorez_Dek_Admin_Load(object sender, EventArgs e)
		{
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var FIO_Lab = dataGridView1.Rows[e.RowIndex].Cells["FIO_Lab"].Value; // Название столбца FIO_Lab
																					 //
				var Him_Podg_3_H2SO4 = dataGridView1.Rows[e.RowIndex].Cells["Him_Podg_3_H2SO4"].Value;
...
var Сomment = dataGridView1.Rows[e.RowIndex].Cells["Сomment"].Value;
   ...
   SET [Date_Create] = @Date_Create
      ,[FIO_Lab] = @FIO_Lab
      ,[Him_Podg_3_H2SO4] = @Him_Podg_3_H2SO4, 
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					//
					command.Parameters.AddWithValue("@Him_Podg_3_H2SO4", Him_Podg_3_H2SO4);
