...
{
	public partial class Himich_Photorez_KisOch_Laborant : Form
	{
		public Himich_Photorez_KisOch_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Himich_Photorez_KisOch_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
