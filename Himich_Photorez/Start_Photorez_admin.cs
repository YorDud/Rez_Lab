...
using Rez_Lab.Himich_Photorez_KisOch;
using Rez_Lab.Himich_Photorez_Dek;


namespace Rez_Lab
{
    public partial class Start_Photorez_admin : Form
    {

        
        public Start_Photorez_admin()
        {
            InitializeComponent();
        ...
        public Start_Photorez_admin(Avtorize aavtorize)
        {
            InitializeComponent();
        ...
        private void Start_Photorez_admin_Load(object sender, EventArgs e)
        {
		...
		{
			this.Hide();
			Himich_Photorez_Microtrav_Admin TM2A = new Himich_Photorez_Microtrav_Admin();
			TM2A.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Himich_Photorez_Dek_Admin poa = new Himich_Photorez_Dek_Admin();
			poa.ShowDialog();
			this.Show();
		...
		{
			this.Hide();
			Himich_Photorez_KisOch_Admin poa = new Himich_Photorez_KisOch_Admin();
			poa.ShowDialog();
			this.Show();
		}
