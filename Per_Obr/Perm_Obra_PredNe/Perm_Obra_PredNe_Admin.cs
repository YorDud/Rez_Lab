...
namespace Rez_Lab.Perm_Obra_PredNe
{
	public partial class Perm_Obra_PredNe_Admin : Form
	{
		public Perm_Obra_PredNe_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Perm_Obra_PredNe_Admin_Load(object sender, EventArgs e)
		{
