...
namespace Rez_Lab.Perm_Obra_PredNe2
{
	public partial class Perm_Obra_PredNe2_Admin : Form
	{
		public Perm_Obra_PredNe2_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Perm_Obra_PredNe2_Admin_Load(object sender, EventArgs e)
		{
