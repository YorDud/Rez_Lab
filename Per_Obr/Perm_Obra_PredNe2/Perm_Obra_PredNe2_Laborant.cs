...
{
	public partial class Perm_Obra_PredNe2_Laborant : Form
	{
		public Perm_Obra_PredNe2_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Perm_Obra_PredNe2_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
   ...
   SET [Per_Obr_4_Н2SO4] = @Per_Obr_4_Н2SO4, 
[Per_Obr_4_DES430] = @Per_Obr_4_DES430
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Per_Obr_4_Н2SO4" && column.Name != "Per_Obr_4_DES430")
				{
