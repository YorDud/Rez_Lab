...
namespace Rez_Lab.Black_Hole_Cleaner
{
	public partial class DES_KisTrav_Admin : Form
	{
		public DES_KisTrav_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void DES_KisTrav_Admin_Load(object sender, EventArgs e)
		{
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Pro_Photorez_3_Correction_Mat = dataGridView1.Rows[e.RowIndex].Cells["Pro_Photorez_3_Correction_Mat"].Value;
				var Pro_Photorez_3_Correction_Score = dataGridView1.Rows[e.RowIndex].Cells["Pro_Photorez_3_Correction_Score"].Value;
...
var Сomment = dataGridView1.Rows[e.RowIndex].Cells["Сomment"].Value;
   ...
   SET [Date_Create] = @Date_Create
      ,[FIO_Lab] = @FIO_Lab
      ,[Pro_Photorez_3_Cu2] = @Pro_Photorez_3_Cu2,
...
[Pro_Photorez_3_Correction_Mat] = @Pro_Photorez_3_Correction_Mat,
[Pro_Photorez_3_Correction_Score] = @Pro_Photorez_3_Correction_Score
      ,[FIO_tech] = @FIO_tech
,[Date_tech] = @Date_tech
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Pro_Photorez_3_Correction_Mat", Pro_Photorez_3_Correction_Mat);
					command.Parameters.AddWithValue("@Pro_Photorez_3_Correction_Score", Pro_Photorez_3_Correction_Score);
