...
{
	public partial class DES_KisTrav_Laborant : Form
	{
		public DES_KisTrav_Laborant()
		{
			InitializeComponent();
			//label11.Text = "Na2CO3 - 8.0-12                NaHCO3 - 0.4-3.0\r\nA/B - 0.45-0.49                  pH - 10.4-11.8\r\nСухой остаток 10-50 г/л";
		...
		private void LoadData()
		{
			...
			{
				connection.Open();
				dataAdapter = new SqlDataAdapter("SELECT * FROM DES_KisTrav ORDER BY Date_Create DESC", connection);
				...
				//
				dataGridView1.Columns["Pro_Photorez_3_Cu2"].HeaderText = "Cu2+";
				dataGridView1.Columns["Pro_Photorez_3_Plotnost"].HeaderText = "Плотность";
				dataGridView1.Columns["Pro_Photorez_3_HCl"].HeaderText = "HCl";
				dataGridView1.Columns["Pro_Photorez_3_NH4Cl"].HeaderText = "NH4Cl";
				dataGridView1.Columns["Pro_Photorez_3_pH"].HeaderText = "pH";
				dataGridView1.Columns["Pro_Photorez_3_Correction_Mat"].HeaderText = "Корректировка материал";
				dataGridView1.Columns["Pro_Photorez_3_Correction_Score"].HeaderText = "Корректировка количество";
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Pro_Photorez_3_Cu2"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Pro_Photorez_3_Plotnost"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Pro_Photorez_3_HCl"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Pro_Photorez_3_NH4Cl"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void DES_KisTrav_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void LoadDataDateTimePicker(DateTime date)
		{
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string query = "SELECT * FROM DES_KisTrav WHERE CAST(Date_Create AS DATE) = @SelectedDate ORDER BY Date_Create DESC";
		...
		private void LoadDataByDateRange(DateTime startDate, DateTime endDate)
		{
			...
			{
				connection.Open();
				string query = "SELECT * FROM DES_KisTrav WHERE CAST(Date_Create AS DATE) BETWEEN @StartDate AND @EndDate ORDER BY Date_Create DESC";
				using (SqlCommand command = new SqlCommand(query, connection))
				{
		...
		private void Add_Row()
		{
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string sqlInsert = "INSERT INTO DES_KisTrav ([Date_Create],[FIO_Lab]) " +
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Pro_Photorez_3_Cu2 = dataGridView1.Rows[rowIndex].Cells["Pro_Photorez_3_Cu2"].Value;
				var Pro_Photorez_3_Plotnost = dataGridView1.Rows[rowIndex].Cells["Pro_Photorez_3_Plotnost"].Value;
				var Pro_Photorez_3_HCl = dataGridView1.Rows[rowIndex].Cells["Pro_Photorez_3_HCl"].Value;
				var Pro_Photorez_3_NH4Cl = dataGridView1.Rows[rowIndex].Cells["Pro_Photorez_3_NH4Cl"].Value;
				...
				string updateQuery = @"
            UPDATE DES_KisTrav
   SET [Pro_Photorez_3_Cu2] = @Pro_Photorez_3_Cu2,
[Pro_Photorez_3_Plotnost] = @Pro_Photorez_3_Plotnost,
[Pro_Photorez_3_HCl] = @Pro_Photorez_3_HCl,
[Pro_Photorez_3_NH4Cl] = @Pro_Photorez_3_NH4Cl,
[Pro_Photorez_3_pH] = @Pro_Photorez_3_pH
	...
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					//
					command.Parameters.AddWithValue("@Pro_Photorez_3_Cu2", Pro_Photorez_3_Cu2);
					command.Parameters.AddWithValue("@Pro_Photorez_3_Plotnost", Pro_Photorez_3_Plotnost);
					command.Parameters.AddWithValue("@Pro_Photorez_3_HCl", Pro_Photorez_3_HCl);
					command.Parameters.AddWithValue("@Pro_Photorez_3_NH4Cl", Pro_Photorez_3_NH4Cl);
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Pro_Photorez_3_Cu2" && column.Name != "Pro_Photorez_3_Plotnost" && column.Name != "Pro_Photorez_3_HCl" && column.Name != "Pro_Photorez_3_NH4Cl" && column.Name != "Pro_Photorez_3_pH")
				{
		...
		private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Pro_Photorez_3_Cu2 = dataGridView1.Rows[e.RowIndex].Cells["Pro_Photorez_3_Cu2"].Value;
				var Pro_Photorez_3_Plotnost = dataGridView1.Rows[e.RowIndex].Cells["Pro_Photorez_3_Plotnost"].Value;
				var Pro_Photorez_3_HCl = dataGridView1.Rows[e.RowIndex].Cells["Pro_Photorez_3_HCl"].Value;
				var Pro_Photorez_3_NH4Cl = dataGridView1.Rows[e.RowIndex].Cells["Pro_Photorez_3_NH4Cl"].Value;
