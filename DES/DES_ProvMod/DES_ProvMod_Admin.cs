...
{
	public partial class DES_ProvMod_Admin : Form
	{
		public DES_ProvMod_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void DES_ProvMod_Admin_Load(object sender, EventArgs e)
		{
...
var Сomment = dataGridView1.Rows[e.RowIndex].Cells["Сomment"].Value;
   ...
   SET [Date_Create] = @Date_Create
      ,[FIO_Lab] = @FIO_Lab
      ,[Pro_Photorez_1_CO32] = @Pro_Photorez_1_CO32,
