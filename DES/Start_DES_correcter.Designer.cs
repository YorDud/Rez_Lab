namespace Rez_Lab
{
    partial class Start_DES_correcter
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_DES_correcter));
			...
			this.button6.Text = "Снятие фоторезиста";
			...
			this.button1.Text = "Проявочный модуль";
			...
			this.button5.Text = "Кислое травление";
			...
			this.button4.Text = "Ультрафильтрация";
			...
			this.Name = "Start_DES_correcter";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_DES_correcter_Load);
