...
using Rez_Lab.DES_ProvMod;
using Rez_Lab.DES_Snatie_Photorez;


namespace Rez_Lab
{
    public partial class Start_DES_admin : Form
    {

        
        public Start_DES_admin()
        {
            InitializeComponent();
        ...
        public Start_DES_admin(Avtorize aavtorize)
        {
            InitializeComponent();
        ...
        private void Start_DES_admin_Load(object sender, EventArgs e)
        {
		...
		{
			this.Hide();
			DES_Ult1_Admin TM2A = new DES_Ult1_Admin();
			TM2A.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			DES_KisTrav_Admin poa = new DES_KisTrav_Admin();
			poa.ShowDialog();
			this.Show();
		...
		{
			this.Hide();
			DES_ProvMod_Admin poa = new DES_ProvMod_Admin();
			poa.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			DES_Snatie_Photorez_Admin poa = new DES_Snatie_Photorez_Admin();
			poa.ShowDialog();
			this.Show();
