...
{
	public partial class DES_Ult1_Laborant : Form
	{
		public DES_Ult1_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Pro_Photorez_2_ostat"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void DES_Ult1_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Pro_Photorez_2_ostat = dataGridView1.Rows[rowIndex].Cells["Pro_Photorez_2_ostat"].Value;
...
[Pro_Photorez_2_ostat] = @Pro_Photorez_2_ostat
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Pro_Photorez_2_CO32" && column.Name != "Pro_Photorez_2_CO3" && column.Name != "Pro_Photorez_2_pH" && column.Name != "Pro_Photorez_2_A_B" && column.Name != "Pro_Photorez_2_ostat")
				{
