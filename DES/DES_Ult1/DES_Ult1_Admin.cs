...
{
	public partial class DES_Ult1_Admin : Form
	{
		public DES_Ult1_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void DES_Ult1_Admin_Load(object sender, EventArgs e)
		{
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Pro_Photorez_2_ostat = dataGridView1.Rows[e.RowIndex].Cells["Pro_Photorez_2_ostat"].Value;
...
[Pro_Photorez_2_ostat] = @Pro_Photorez_2_ostat,
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Pro_Photorez_2_ostat", Pro_Photorez_2_ostat);
