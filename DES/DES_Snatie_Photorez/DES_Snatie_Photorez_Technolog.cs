...
{
	public partial class DES_Snatie_Photorez_Technolog : Form
	{
		public DES_Snatie_Photorez_Technolog()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void DES_Snatie_Photorez_Technolog_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		//		string query = @"
		//      UPDATE DES_Snatie_Photorez SET
		//          [Date_tech] = @Date_tech,
