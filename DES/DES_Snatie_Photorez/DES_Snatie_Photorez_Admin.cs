...
{
	public partial class DES_Snatie_Photorez_Admin : Form
	{
		public DES_Snatie_Photorez_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void DES_Snatie_Photorez_Admin_Load(object sender, EventArgs e)
		{
