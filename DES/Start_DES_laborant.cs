...
namespace Rez_Lab
{
    public partial class Start_DES_laborant : Form
    {
        public Start_DES_laborant()
        {
            InitializeComponent();
		...
		{
			//this.Hide();
			//DES_Laborant tmc = new DES_Laborant();
			//tmc.ShowDialog();
			//this.Show();
		}
		...
		{
			this.Hide();
			DES_ProvMod_Laborant tmc = new DES_ProvMod_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			DES_Ult1_Laborant tmc = new DES_Ult1_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			DES_KisTrav_Laborant tmc = new DES_KisTrav_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			DES_Snatie_Photorez_Laborant tmc = new DES_Snatie_Photorez_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
