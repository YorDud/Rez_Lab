...
namespace Rez_Lab
{
    public partial class Start_DES_technolog : Form
    {
		private Timer timer;
        ...
        private void Start_DES_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
		...
		{
			//this.Hide();
			//DES_Technolog tmd = new DES_Technolog();
			//tmd.ShowDialog();
			//this.Show();
		}
...
//		}
		...
		{
			this.Hide();
			DES_ProvMod_Technolog tmd = new DES_ProvMod_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			DES_Ult1_Technolog tmd = new DES_Ult1_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			DES_KisTrav_Technolog tmd = new DES_KisTrav_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
...
WHERE ([FIO_tech] IS NULL OR [FIO_tech] = '') 
   OR ([Date_tech] IS NULL OR [Date_tech] = '');";
		...
		{
			this.Hide();
			DES_Snatie_Photorez_Technolog tmd = new DES_Snatie_Photorez_Technolog();
			tmd.ShowDialog();
			this.Show();
