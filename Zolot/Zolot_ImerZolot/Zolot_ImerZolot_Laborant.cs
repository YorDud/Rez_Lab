...
{
	public partial class Zolot_ImerZolot_Laborant : Form
	{
		public Zolot_ImerZolot_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Zolot_Au2"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Zolot_ImerZolot_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Zolot_Au2 = dataGridView1.Rows[rowIndex].Cells["Zolot_Au2"].Value;
...
[Zolot_Plotnost] = @Zolot_Plotnost
	...
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					//
					command.Parameters.AddWithValue("@Zolot_Au2", Zolot_Au2);
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Zolot_Au2" && column.Name != "Zolot_Ni2" && column.Name != "Zolot_Cu2" && column.Name != "Zolot_pH" && column.Name != "Zolot_Plotnost")
				{
		...
		private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Zolot_Au2 = dataGridView1.Rows[e.RowIndex].Cells["Zolot_Au2"].Value;
		...
		private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
		{
			if (e.RowIndex >= 0 && e.ColumnIndex == 3) // Проверяем, что ячейка выбрана
			{
				...
				using (Form inputForm = new Form())
				{
					...
					{
						Text = "m1 – масса тигля после прокаливания, г;\r\nm2 – масса тигля с золотом после проведения анализа, г",
						Top = 40,
						Left = 10,
						Width = 330,
						Height = 100
					...
					calculateButton.Click += (s, args) =>
					{
						...
						{
							double result = Math.Round((v1 - v2) * 20, 2); // Пример формулы (сложение)
