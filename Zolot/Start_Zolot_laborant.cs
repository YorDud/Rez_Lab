...
namespace Rez_Lab
{
    public partial class Start_Zolot_laborant : Form
    {
        public Start_Zolot_laborant()
        {
            InitializeComponent();
		...
		{
			this.Hide();
			Zolot_KisOch_Laborant tmc = new Zolot_KisOch_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_Microtrav_Laborant tmc = new Zolot_Microtrav_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_PredActiv_Laborant tmc = new Zolot_PredActiv_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_Activ_Laborant tmc = new Zolot_Activ_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_PostActiv_Laborant tmc = new Zolot_PostActiv_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_HimNik_Laborant tmc = new Zolot_HimNik_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_Azot_Laborant tmc = new Zolot_Azot_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_ImerZolot_Laborant tmc = new Zolot_ImerZolot_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
