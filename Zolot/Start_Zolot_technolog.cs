...
namespace Rez_Lab
{
    public partial class Start_Zolot_technolog : Form
    {
		private Timer timer;
        ...
        private void Start_Zolot_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
		...
		{
			this.Hide();
			Galvan_Zat_Technolog tmd = new Galvan_Zat_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_Technolog tmd = new Galvan_Line_MG_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_PAL_Technolog tmd = new Galvan_Line_PAL_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photomask_Technolog tmd = new Proyavlen_Photomask_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_KisOch_Technolog tmd = new Zolot_KisOch_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_Microtrav_Technolog tmd = new Zolot_Microtrav_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_PredActiv_Technolog tmd = new Zolot_PredActiv_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_Activ_Technolog tmd = new Zolot_Activ_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_PostActiv_Technolog tmd = new Zolot_PostActiv_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_HimNik_Technolog tmd = new Zolot_HimNik_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_Azot_Technolog tmd = new Zolot_Azot_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_ImerZolot_Technolog tmd = new Zolot_ImerZolot_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
...
WHERE ([FIO_tech] IS NULL OR [FIO_tech] = '') 
   OR ([Date_tech] IS NULL OR [Date_tech] = '');";
		...
		{
			//this.Hide();
			//Zolot_Azot012_Technolog tmd = new Zolot_Azot012_Technolog();
			//tmd.ShowDialog();
			//this.Show();
		}
		...
		{
			//this.Hide();
			//Zolot_Azot022_Technolog tmd = new Zolot_Azot022_Technolog();
			//tmd.ShowDialog();
			//this.Show();
		}
...
//		}
		...
		//	blinkTimer8.Interval = 350; // 820 миллисекунд
...
//					SqlCommand command = new SqlCommand(query, connection);
//					int count = (int)command.ExecuteScalar(); // Получение количества выполненных условий
//					//label22.Text = count.ToString(); // Обновление значения label11
//				}
//				catch (SqlException ex)
//				{
//					// Обработка ошибок подключения или выполнения запроса    
...
//			blinkTimer9.Interval = 350; // 920 миллисекунд
