...
namespace Rez_Lab
{
	public partial class Start_Zolot_correcter : Form
	{
		...
		private void Start_Zolot_correcter_Load(object sender, EventArgs e)
		{
...
//WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
//AND (
//    ([Zolot_Correction] IS NOT NULL AND [Zolot_Correction] <> '') OR 
//    ([Zolot_Correction] IS NOT NULL AND [Zolot_Correction] <> '') OR 
//    ([Zolot_Correction] IS NOT NULL AND [Zolot_Correction] <> '') OR 
//    ([Zolot_Correction] IS NOT NULL AND [Zolot_Correction] <> '') OR 
//    ([Zolot_Correction] IS NOT NULL AND [Zolot_Correction] <> '') OR 
//    ([Zolot_Correction] IS NOT NULL AND [Zolot_Correction] <> '') OR 
//    ([Zolot_Correction] IS NOT NULL AND [Zolot_Correction] <> '') OR 
//    ([Zolot_Correction] IS NOT NULL AND [Zolot_Correction] <> '')
//);
//";
...
//		}
		...
		{
			this.Hide();
			Zolot_KisOch_Corrector tmc = new Zolot_KisOch_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_Microtrav_Corrector tmc = new Zolot_Microtrav_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_PredActiv_Corrector tmc = new Zolot_PredActiv_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_Activ_Corrector tmc = new Zolot_Activ_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_PostActiv_Corrector tmc = new Zolot_PostActiv_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_HimNik_Corrector tmc = new Zolot_HimNik_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_Azot_Corrector tmc = new Zolot_Azot_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_ImerZolot_Corrector tmc = new Zolot_ImerZolot_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Zolot_Correction_Mat] IS NOT NULL AND [Zolot_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
...
";
		...
		private void Zolot_Microtrav()
		{
			string query = @"
         SELECT COUNT(*) 
FROM Zolot_Microtrav
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Zolot_Correction_Mat] IS NOT NULL AND [Zolot_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Zolot_Correction_Score] IS NOT NULL AND [Zolot_Correction_Score] <> ''));";
		...
		private void Zolot_PredActiv()
		{
			string query = @"
         SELECT COUNT(*) 
FROM Zolot_PredActiv
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Zolot_Correction_Mat] IS NOT NULL AND [Zolot_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Zolot_Correction_Score] IS NOT NULL AND [Zolot_Correction_Score] <> ''));";
...
AND (
    ...
    ([Zolot_Correction_Score] IS NOT NULL AND [Zolot_Correction_Score] <> ''));";
		...
		private void Zolot_PostActiv()
		{
			string query = @"
         SELECT COUNT(*) 
FROM Zolot_PostActiv
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Zolot_Correction_Mat] IS NOT NULL AND [Zolot_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Zolot_Correction_Score] IS NOT NULL AND [Zolot_Correction_Score] <> ''));";
		...
		private void InitializeTimer4()
		{
			...
			// Настройка таймера
			blinkTimer4 = new Timer();
			blinkTimer4.Interval = 350; // 420 миллисекунд
			blinkTimer4.Tick += BlinkTimer_Tick4;
		}
...
AND (
    ...
    ([Zolot_Correction_Score] IS NOT NULL AND [Zolot_Correction_Score] <> ''));";
		...
		private void InitializeTimer5()
		{
			...
			// Настройка таймера
			blinkTimer5 = new Timer();
			blinkTimer5.Interval = 350; // 520 миллисекунд
			blinkTimer5.Tick += BlinkTimer_Tick5;
		}
...
AND (
    ...
    ([Zolot_Correction_Score] IS NOT NULL AND [Zolot_Correction_Score] <> ''));";
		...
		private void InitializeTimer6()
		{
			...
			// Настройка таймера
			blinkTimer6 = new Timer();
			blinkTimer6.Interval = 350; // 620 миллисекунд
			blinkTimer6.Tick += BlinkTimer_Tick6;
		}
		...
		private void Zolot_ImerZolot()
		{
			string query = @"
         SELECT COUNT(*) 
FROM Zolot_ImerZolot
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Zolot_Correction_Mat] IS NOT NULL AND [Zolot_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Zolot_Correction_Score] IS NOT NULL AND [Zolot_Correction_Score] <> ''));";
		...
		private void InitializeTimer7()
		{
			...
			// Настройка таймера
			blinkTimer7 = new Timer();
			blinkTimer7.Interval = 350; // 720 миллисекунд
			blinkTimer7.Tick += BlinkTimer_Tick7;
		}
		...
		{
		"!!! Кислый очиститель !!!",
		"!!! Раствор микротравления !!!",
		"!!! Предактиватор !!!",
		"!!! Активатор !!!",
		"!!! Постактиватор !!!",
		"!!! Химический никель !!!",
		"!!! Ванна хранения азотной кислоты !!!",
		"!!! Иммерсионное золото !!!"
		};
		...
		private DataSet GetAllDataFromDatabase()
		{
			...
			string query = @"
            SELECT 
                [Zolot_Correction_Mat],
                [Zolot_Correction_Score],
                [Сomment]
            FROM 
                Zolot_KisOch
            WHERE 
                ...
                AND (
                    ([Zolot_Correction_Mat] IS NOT NULL AND [Zolot_Correction_Mat] <> '') OR ([Сomment] IS NOT NULL AND [Сomment] <> '') 
                    OR ([Zolot_Correction_Score] IS NOT NULL AND [Zolot_Correction_Score] <> '')
                );
...
SELECT 
		...
		{
			this.Hide();
			//Zolot_Azot012_Corrector tmc = new Zolot_Azot012_Corrector();
			//tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			//Zolot_Azot022_Corrector tmc = new Zolot_Azot022_Corrector();
			//tmc.ShowDialog();
			this.Show();
		}

//		private void Zolot_Azot012()
//		{
//			string query = @"
//        SELECT COUNT(*) 
//FROM Zolot_Azot012
...
//		}
		...
		//	// Настройка таймера
		//	blinkTimer8 = new Timer();
		//	blinkTimer8.Interval = 350; // 11250 миллисекунд
		//	blinkTimer8.Tick += BlinkTimer_Tick8;
		//}
...
//			// Настройка таймера
//			blinkTimer9 = new Timer();
//			blinkTimer9.Interval = 350; // 12250 миллисекунд
//			blinkTimer9.Tick += BlinkTimer_Tick9;
//		}
...
//		{
//			blinkTimer9.Stop(); // Останавливаем таймер
//			//button22.BackColor = Color.Green; // Сбрасываем цвет кнопки
//		}

		//private void BlinkTimer_Tick9(object sender, EventArgs e)
		//{
		//	// Проверяем, больше ли значение в label, чем 0
		//	if (int.TryParse(label22.Text, out int labelValue) && labelValue > 0)
		//	{
		//		// Меняем цвет кнопки в зависимости от isRed
		//		if (isRed9)
		//		{
