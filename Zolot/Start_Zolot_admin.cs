...
using Rez_Lab.Zolot_Azot;
using Rez_Lab.Zolot_Microtrav;
using Rez_Lab.Zolot_PredActiv;

namespace Rez_Lab
{
    public partial class Start_Zolot_admin : Form
    {

        
        public Start_Zolot_admin()
        {
            InitializeComponent();
        ...
        public Start_Zolot_admin(Avtorize aavtorize)
        {
            InitializeComponent();
        ...
        private void Start_Zolot_admin_Load(object sender, EventArgs e)
        {
		...
		{
			this.Hide();
			Zolot_KisOch_Admin TM1A = new Zolot_KisOch_Admin();
			TM1A.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_Microtrav_Admin TM2A = new Zolot_Microtrav_Admin();
			TM2A.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_PredActiv_Admin poa = new Zolot_PredActiv_Admin();
			poa.ShowDialog();
			this.Show();
		...
		{
			this.Hide();
			Zolot_Activ_Admin poa = new Zolot_Activ_Admin();
			poa.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_PostActiv_Admin poa = new Zolot_PostActiv_Admin();
			poa.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_HimNik_Admin poa = new Zolot_HimNik_Admin();
			poa.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_Azot_Admin poa = new Zolot_Azot_Admin();
			poa.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Zolot_ImerZolot_Admin poa = new Zolot_ImerZolot_Admin();
			poa.ShowDialog();
			this.Show();
		}
