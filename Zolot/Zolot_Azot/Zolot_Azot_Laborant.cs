...
{
	public partial class Zolot_Azot_Laborant : Form
	{
		public Zolot_Azot_Laborant()
		{
			InitializeComponent();
		...
		private void LoadData()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				dataGridView1.Columns["Zolot_HNO3"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Zolot_Azot_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Zolot_HNO3 = dataGridView1.Rows[rowIndex].Cells["Zolot_HNO3"].Value;
