...
{
	public partial class Zolot_Azot_Admin : Form
	{
		public Zolot_Azot_Admin()
		{
			InitializeComponent();
		...
		private void Zolot_Azot_Admin_Load(object sender, EventArgs e)
		{
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var FIO_Lab = dataGridView1.Rows[e.RowIndex].Cells["FIO_Lab"].Value; // Название столбца FIO_Lab
																					 //
				var Zolot_HNO3 = dataGridView1.Rows[e.RowIndex].Cells["Zolot_HNO3"].Value;
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					//
					command.Parameters.AddWithValue("@Zolot_HNO3", Zolot_HNO3);
