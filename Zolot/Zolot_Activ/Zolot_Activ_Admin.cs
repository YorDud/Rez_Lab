...
{
	public partial class Zolot_Activ_Admin : Form
	{
		public Zolot_Activ_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Zolot_Activ_Admin_Load(object sender, EventArgs e)
		{
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Zolot_Correction_Mat = dataGridView1.Rows[e.RowIndex].Cells["Zolot_Correction_Mat"].Value;
				var Zolot_Correction_Score = dataGridView1.Rows[e.RowIndex].Cells["Zolot_Correction_Score"].Value;
...
var Сomment = dataGridView1.Rows[e.RowIndex].Cells["Сomment"].Value;
   ...
   SET [Date_Create] = @Date_Create
      ...
      ,[Zolot_S2] = @Zolot_S2
      ,[Zolot_Cl] = @Zolot_Cl,
[Zolot_Correction_Mat] = @Zolot_Correction_Mat,
[Zolot_Correction_Score] = @Zolot_Correction_Score
      ,[FIO_tech] = @FIO_tech
,[Date_tech] = @Date_tech
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Zolot_Correction_Mat", Zolot_Correction_Mat);
					command.Parameters.AddWithValue("@Zolot_Correction_Score", Zolot_Correction_Score);
