...
{
	public partial class Zolot_Activ_Laborant : Form
	{
		public Zolot_Activ_Laborant()
		{
			InitializeComponent();
			//label11.Text = "Na2S2O8 - 120 г/л\r\nОБЪЕМ ВАННЫ: 460 л";
		...
		private void LoadData()
		{
			...
			{
				connection.Open();
				dataAdapter = new SqlDataAdapter("SELECT * FROM Zolot_Activ ORDER BY Date_Create DESC", connection);
				...
				//
				dataGridView1.Columns["Zolot_Pd2"].HeaderText = "Pd2+";
				dataGridView1.Columns["Zolot_Cu2"].HeaderText = "Cu2+";
				dataGridView1.Columns["Zolot_H2SO4"].HeaderText = "H2SO4";
				dataGridView1.Columns["Zolot_Plotnost"].HeaderText = "плотность";
				dataGridView1.Columns["Zolot_Fe2"].HeaderText = "Fe2+";
				dataGridView1.Columns["Zolot_Fe3"].HeaderText = "Fe3+";
				dataGridView1.Columns["Zolot_S2"].HeaderText = "S2-";
				dataGridView1.Columns["Zolot_Cl"].HeaderText = "Сl-";
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Zolot_Pd2"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Zolot_Cu2"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Zolot_H2SO4"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Zolot_Plotnost"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Zolot_Fe2"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Zolot_Fe3"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Zolot_S2"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Zolot_Cl"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Zolot_Activ_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void LoadDataDateTimePicker(DateTime date)
		{
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string query = "SELECT * FROM Zolot_Activ WHERE CAST(Date_Create AS DATE) = @SelectedDate ORDER BY Date_Create DESC";
		...
		private void LoadDataByDateRange(DateTime startDate, DateTime endDate)
		{
			...
			{
				connection.Open();
				string query = "SELECT * FROM Zolot_Activ WHERE CAST(Date_Create AS DATE) BETWEEN @StartDate AND @EndDate ORDER BY Date_Create DESC";
				using (SqlCommand command = new SqlCommand(query, connection))
				{
		...
		private void Add_Row()
		{
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string sqlInsert = "INSERT INTO Zolot_Activ ([Date_Create],[FIO_Lab]) " +
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Zolot_Pd2 = dataGridView1.Rows[rowIndex].Cells["Zolot_Pd2"].Value;
				var Zolot_Cu2 = dataGridView1.Rows[rowIndex].Cells["Zolot_Cu2"].Value;
				var Zolot_H2SO4 = dataGridView1.Rows[rowIndex].Cells["Zolot_H2SO4"].Value;
				var Zolot_Plotnost = dataGridView1.Rows[rowIndex].Cells["Zolot_Plotnost"].Value;
				var Zolot_Fe2 = dataGridView1.Rows[rowIndex].Cells["Zolot_Fe2"].Value;
				var Zolot_Fe3 = dataGridView1.Rows[rowIndex].Cells["Zolot_Fe3"].Value;
				var Zolot_S2 = dataGridView1.Rows[rowIndex].Cells["Zolot_S2"].Value;
				var Zolot_Cl = dataGridView1.Rows[rowIndex].Cells["Zolot_Cl"].Value;
				...
				string updateQuery = @"
            UPDATE Zolot_Activ
   SET [Zolot_Pd2] = @Zolot_Pd2
      ,[Zolot_Cu2] = @Zolot_Cu2
      ,[Zolot_H2SO4] = @Zolot_H2SO4
	...
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					//
					command.Parameters.AddWithValue("@Zolot_Pd2", Zolot_Pd2);
					command.Parameters.AddWithValue("@Zolot_Cu2", Zolot_Cu2);
					command.Parameters.AddWithValue("@Zolot_H2SO4", Zolot_H2SO4);
					command.Parameters.AddWithValue("@Zolot_Plotnost", Zolot_Plotnost);
					command.Parameters.AddWithValue("@Zolot_Fe2", Zolot_Fe2);
					command.Parameters.AddWithValue("@Zolot_Fe3", Zolot_Fe3);
					command.Parameters.AddWithValue("@Zolot_S2", Zolot_S2);
					command.Parameters.AddWithValue("@Zolot_Cl", Zolot_Cl);
					//
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Zolot_Pd2" && column.Name != "Zolot_Cu2" && column.Name != "Zolot_H2SO4" && column.Name != "Zolot_Plotnost" && column.Name != "Zolot_Fe2" && column.Name != "Zolot_Fe3" && column.Name != "Zolot_S2" && column.Name != "Zolot_Cl")
				{
		...
		private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Zolot_Pd2 = dataGridView1.Rows[e.RowIndex].Cells["Zolot_Pd2"].Value;
				var Zolot_Cu2 = dataGridView1.Rows[e.RowIndex].Cells["Zolot_Cu2"].Value;
				var Zolot_H2SO4 = dataGridView1.Rows[e.RowIndex].Cells["Zolot_H2SO4"].Value;
				var Zolot_Plotnost = dataGridView1.Rows[e.RowIndex].Cells["Zolot_Plotnost"].Value;
				var Zolot_Fe2 = dataGridView1.Rows[e.RowIndex].Cells["Zolot_Fe2"].Value;
				var Zolot_Fe3 = dataGridView1.Rows[e.RowIndex].Cells["Zolot_Fe3"].Value;
				var Zolot_S2 = dataGridView1.Rows[e.RowIndex].Cells["Zolot_S2"].Value;
				var Zolot_Cl = dataGridView1.Rows[e.RowIndex].Cells["Zolot_Cl"].Value;
   ...
   SET [Zolot_Pd2] = @Zolot_Pd2
	...
	WHERE ID = @ID";
		...
		{
			if (e.RowIndex >= 0 && e.ColumnIndex == 5) // Проверяем, что ячейка выбрана
			{
				...
				using (Form inputForm = new Form())
				{
					...
					calculateButton.Click += (s, args) =>
					{
						...
						{
							double result = Math.Round(v1 * 0.54, 2); // Пример формулы (сложение)
			...
			else if (e.RowIndex >= 0 && e.ColumnIndex == 3) // Проверяем, что ячейка выбрана
			{
				...
				using (Form inputForm = new Form())
				{
					...
					Label labelValueA = new Label()
					{
						Text = "Ax – оптическая плотность анализируемой пробы;\r\nAст – оптическая плотность пробы стандартного раствора",
						Top = 40,
						Left = 10,
						Width = 330,
						Height = 100
					...
					calculateButton.Click += (s, args) =>
					{
						...
						{
							double result = Math.Round((v1 * 200)/(v2 * 10), 2); // Пример формулы (сложение)
