...
{
	partial class Proyavlen_Photorez_Ult2_Corrector
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Proyavlen_Photorez_Ult2_Corrector));
			...
			// 
			// Proyavlen_Photorez_Ult2_Corrector
			// 
			...
			this.Name = "Proyavlen_Photorez_Ult2_Corrector";
			this.Text = "Лаборатория Резонит";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.Proyavlen_Photorez_Ult2_Corrector_Load);
