...
{
	public partial class Oxide_PredActiv_Admin : Form
	{
		public Oxide_PredActiv_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Oxide_PredActiv_Admin_Load(object sender, EventArgs e)
		{
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var FIO_Lab = dataGridView1.Rows[e.RowIndex].Cells["FIO_Lab"].Value; // Название столбца FIO_Lab
																					 //
				var Oxide_BC101 = dataGridView1.Rows[e.RowIndex].Cells["Oxide_BC101"].Value;
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					//
					command.Parameters.AddWithValue("@Oxide_BC101", Oxide_BC101);
