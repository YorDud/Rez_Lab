...
{
	public partial class Oxide_PredActiv_Laborant : Form
	{
		public Oxide_PredActiv_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Oxide_BC101"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Oxide_PredActiv_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Oxide_BC101 = dataGridView1.Rows[rowIndex].Cells["Oxide_BC101"].Value;
