...
{
	public partial class Oxide_ShelOch_Laborant : Form
	{
		public Oxide_ShelOch_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Oxide_BC721"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Oxide_ShelOch_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Oxide_BC721 = dataGridView1.Rows[rowIndex].Cells["Oxide_BC721"].Value;
