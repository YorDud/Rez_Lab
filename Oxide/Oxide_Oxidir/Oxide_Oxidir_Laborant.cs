...
{
	public partial class Oxide_Oxidir_Laborant : Form
	{
		public Oxide_Oxidir_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Oxide_H2SO4"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Oxide_H2O2"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Oxide_Cu2"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Oxide_podtrav"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Oxide_BROX1100"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Oxide_Oxidir_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
...
[Oxide_BROX1100] = @Oxide_BROX1100
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Oxide_H2SO4" && column.Name != "Oxide_H2O2" && column.Name != "Oxide_Cu2" && column.Name != "Oxide_podtrav" && column.Name != "Oxide_BROX1100")
				{
...
[Oxide_BROX1100] = @Oxide_BROX1100
	...
	WHERE ID = @ID";
		...
		private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			//		Label labelValueA = new Label()
			//		{
			//			Text = "а - количество 0,02 М (0,1 Н) раств. KMnO4, израсх. на титрование, мл",
			//			Top = 40,
			//			Left = 10,
			//			Width = 330,
			//			Height = 100
			...
			//			{
			//				double result = Math.Round(v1 * 8.602, 2); // Пример формулы (сложение)
			...
			//			if (double.TryParse(value1.Text, out double v1))
			//			{
			//				double result = Math.Round(v1 * 3.175, 2); // Пример формулы (сложение)
			...
			//		Label labelValueA = new Label()
			//		{
			//			Text = "w1 - масса высушенного образца до микротравления, г\r\nw2 - масса высушенного образца после микротравления, г",
			//			Top = 40,
			//			Left = 10,
			//			Width = 330,
			//			Height = 100
			...
			//			if (double.TryParse(value1.Text, out double v1) && double.TryParse(value2.Text, out double v2))
			//			{
			//				double result = Math.Round((v1 - v2) * 5.6, 2); // Пример формулы (сложение)
