namespace Rez_Lab
{
    partial class Start_Oxide_correcter
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Oxide_correcter));
			...
			this.button1.Text = "Щелочной очиститель";
			...
			this.button5.Text = "Оксидирование";
			...
			this.button4.Text = "Предактиватор";
			...
			this.Name = "Start_Oxide_correcter";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Oxide_correcter_Load);
