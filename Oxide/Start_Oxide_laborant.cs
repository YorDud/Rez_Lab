...
namespace Rez_Lab
{
    public partial class Start_Oxide_laborant : Form
    {
        public Start_Oxide_laborant()
        {
            InitializeComponent();
		...
		{
			this.Hide();
			Oxide_ShelOch_Laborant tmc = new Oxide_ShelOch_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Oxide_PredActiv_Laborant tmc = new Oxide_PredActiv_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Oxide_Oxidir_Laborant tmc = new Oxide_Oxidir_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
