...
using Rez_Lab.Oxide_ShelOch;
using Rez_Lab.Oxide_PredActiv;


namespace Rez_Lab
{
    public partial class Start_Oxide_admin : Form
    {

        
        public Start_Oxide_admin()
        {
            InitializeComponent();
        ...
        public Start_Oxide_admin(Avtorize aavtorize)
        {
            InitializeComponent();
        ...
        private void Start_Oxide_admin_Load(object sender, EventArgs e)
        {
		...
		{
			this.Hide();
			Oxide_PredActiv_Admin TM2A = new Oxide_PredActiv_Admin();
			TM2A.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Oxide_Oxidir_Admin poa = new Oxide_Oxidir_Admin();
			poa.ShowDialog();
			this.Show();
		...
		{
			this.Hide();
			Oxide_ShelOch_Admin poa = new Oxide_ShelOch_Admin();
			poa.ShowDialog();
			this.Show();
		}
