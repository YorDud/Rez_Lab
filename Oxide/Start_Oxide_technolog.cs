...
namespace Rez_Lab
{
    public partial class Start_Oxide_technolog : Form
    {
		private Timer timer;
        ...
        private void Start_Oxide_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
...
//		}
		...
		{
			this.Hide();
			Oxide_ShelOch_Technolog tmd = new Oxide_ShelOch_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Oxide_PredActiv_Technolog tmd = new Oxide_PredActiv_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Oxide_Oxidir_Technolog tmd = new Oxide_Oxidir_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
